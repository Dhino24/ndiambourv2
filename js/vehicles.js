...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    console.log("Véhicules chargés depuis JSON:", vehicles.length);
  } catch (error) {
    console.error("Erreur chargement JSON:", error);
    // Utiliser localStorage comme fallback
    vehicles = JSON.parse(localStorage.getItem('vehicles') || '[]');
    console.log("Fallback: véhicules chargés depuis localStorage:", vehicles.length);
    
    // Si aucun véhicule n'est trouvé, ajouter des véhicules démo
    ...
    try {
      ...
      const table = $('#vehicles-table').DataTable({
        ...
        columns: [
          ...
          {data: 'type', render: t => ({sedan:'Berline',suv:'SUV',luxury:'Luxe',van:'Minivan',pickup:'Pick-up',hatchback:'Citadine'})[t] || t},
          {data: 'year'},
  ...
  function saveVehicle() {
    ...
    // Sauvegarder dans localStorage pour les modifications temporaires
    // Dans une version production, il faudrait mettre à jour le fichier JSON
  ...
  // Demo data - utilisé uniquement si aucun véhicule n'est trouvé
    ...
    vehicles = [
      {
        ...
        images: [
          'https://images.pexels.com/photos/12117992/pexels-photo-12117992.jpeg',
          'https://images.unsplash.com/photo-1669248945574-41fbfa29974e'
        ],
        featured: true,
        createdAt: new Date().toISOString()
      },
      {
        ...
        images: [
          'https://images.pexels.com/photos/10889836/pexels-photo-10889836.jpeg',
          'https://images.unsplash.com/photo-1652389827581-c5ee77cc7862'
        ],
        featured: true,
        createdAt: new Date().toISOString()
      },
      {
        ...
        images: [
          'https://images.pexels.com/photos/9746029/pexels-photo-9746029.jpeg'
        ],
        featured: false,
        createdAt: new Date().toISOString()
      },
